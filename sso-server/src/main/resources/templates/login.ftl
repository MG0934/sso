...
<body class="hold-transition login-page">
    ...
    <div class="login-box">
        ...
        <form action="${request.contextPath}/web/doLogin">
            <div class="login-box-body">
                ...
                <div class="form-group has-feedback">
                    <input type="password" name="password" class="form-control" placeholder="Please input password." value="admin" maxlength="50" >
